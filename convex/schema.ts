...
export default defineSchema({
  ...
  watchJobs: defineTable({
    ...
    createdAt: v.number(),
    updatedAt: v.number(),
  }).index("by_owner", ["ownerKey"]).index("by_next_run", ["nextRunAt"]),
  watchRuns: defineTable({
    ownerKey: v.string(),
  ...
  appConfig: defineTable({
    ...
    statusHeartbeatHours: v.optional(v.number()),
    lastStatusHeartbeatAt: v.optional(v.number()),
